...
function SignUp() {
  ...
  const handleCreateAcc = async (e) => {
    ...
    const email = userLog.current.email.value;
    const password = userLog.current.password.value;
    const userInFoLog = {
      email,
      password,
    };
  ...
  return (
    <form ref={userLog} onSubmit={handleCreateAcc}>
